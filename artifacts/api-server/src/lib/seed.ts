...
const BOARD_SPACES = [
  ...
  // ── Bottom row (1–7) ───────────────────────────────────────────────────
  { position:  1, name: "Lost & Found Area (1/F)",        type: "property", colorGroup: "brown",      rentValue:  30, propertyValue:  30 },
  { position:  2, name: "Flagpole Garden (5/F)",          type: "property", colorGroup: "brown",      rentValue:  20, propertyValue:  20 },
  { position:  3, name: "Co-Curricular Activity Fees",    type: "tax",      colorGroup: null,          rentValue: 200, propertyValue:   0 },
  { position:  4, name: "Snack Bar (5/F)",                type: "property", colorGroup: "light_blue", rentValue:  40, propertyValue:  40 },
  { position:  5, name: "Chance",                         type: "chance",   colorGroup: null,          rentValue:   0, propertyValue:   0 },
  { position:  6, name: "Nurse Office (1/F)",             type: "property", colorGroup: "light_blue", rentValue:  50, propertyValue:  50 },
  { position:  7, name: "Back Entry Guard Booth (G/F)",   type: "property", colorGroup: "light_blue", rentValue:  60, propertyValue:  60 },

  // ── Left column (9–15) ─────────────────────────────────────────────────
  { position:  9, name: "CCDD (5/F)",                 type: "property", colorGroup: "pink",       rentValue:  70, propertyValue:  70 },
  { position: 10, name: "Staff Canteen (1/F)",        type: "property", colorGroup: "pink",       rentValue:  80, propertyValue:  80 },
  ...
  { position: 26, name: "CUGO (5/F)",                 type: "property", colorGroup: "green",      rentValue: 190, propertyValue: 190 },
