...
const BOARD_CORRECTIONS: Array<{
  ...
  { position: 14, name: "Artists in Residence B208 (2/F)"                                 },
  ...
  { position: 19, name: "Gymnasium (G/F)"                                                  },
  { position: 21, name: "ELW Trip"                                                        },
  { position: 22, name: "Student Canteen (1/F)"                                           },
  { position: 23, name: "Dance Studio A004 (G/F)"                                          },
  { position: 25, name: "Swimming Pool Viewing Balcony (4/F)",      colorGroup: "green"   },
